            ...
            {section.type === 'header' && (
              <header className="bg-white shadow-sm border-b">
                <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
                  <div className="text-xl font-bold">{section.content.logo}</div>
                  <nav className="hidden md:flex space-x-6">
                    {section.content.menuItems?.map((item: string, index: number) => (
                      <a key={index} href="#" className="text-slate-600 hover:text-slate-900">
                        {item}
                      </a>
                    ))}
                  </nav>
                  <div className="text-slate-600">{section.content.phoneNumber}</div>
                </div>
              </header>
            )}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div>
                    ...
                    <div className="space-y-3">
                      ...
                      <p><strong>Hours:</strong> {section.content.hours}</p>
                    </div>
                  </div>
                  <div>
      ...
      <div className="bg-white border-b px-6 py-4 sticky top-0 z-10">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            <Button variant="outline" onClick={() => navigate('/editor/templates')}>
